      ...
      <div className='col-span-2 px-5 my-auto ' >
        ...
        />
         ...
         <div className='my-8' data-aos="fade-in" data-aos-duration='2000'>
           <a href='https://drive.google.com/file/d/1gwaOYlx4Xdd_SbjFNLsQjoTQOFosFkB0/view?usp=sharing' className='px-6 py-3 w-full rounded-xl mr-4 border border-gray-400 hover:bg-gradient-to-br  from-cyan-500 to-blue-500  hover:from-cyan-700 hover:to-blue-700 text-white hover:border-none'>
           Download CV
           </a> 
